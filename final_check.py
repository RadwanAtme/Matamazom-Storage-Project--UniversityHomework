...
PROVIDED_PART1_FILES = ['amount_set.h']
PROVIDED_PART2_FILES = ['matamazom.h', 'matamazom_print.h', 'matamazom_print.c',
                        'list.h', 'set.h', 'libmtm.a']
PROVIDED_TEST_FILES = ['test_utilities.h',
                       'amount_set_tests.c', 'amount_set_tests.h', 'amount_set_main.c',
                       'matamazom_tests.c', 'matamazom_tests.h', 'matamazom_main.c',
                       'expected_best_selling.txt', 'expected_no_selling.txt', 'expected_filtered.txt',
...
MINIMUM_REQUIRED_TOP_DIR_FILES = ['matamazom.c', 'amount_set.c']
...
PART1_NAME = 'amount_set'
EXEC_NAME_PART1 = 'amount_set'
GCC_ARGS_PART1 = BASIC_GCC_ARGS.copy()
# list of pairs: (subdirectory, glob pattern)
GCC_SOURCES_PART1 = [('', 'amount_set*.c'), (TESTS_DIR, 'amount_set*.c')]
GCC_ARGS_SUFFIX_PART1 = []

PART2_NAME = 'matamazom'
EXEC_NAME_PART2 = 'matamazom'
GCC_ARGS_PART2 = BASIC_GCC_ARGS.copy()
# list of pairs: (subdirectory, glob pattern)
GCC_SOURCES_PART2 = [('', '*.c' ), (TESTS_DIR, 'matamazom*.c')]
GCC_ARGS_SUFFIX_PART2 = ['-L.', '-lm', '-lmtm']
